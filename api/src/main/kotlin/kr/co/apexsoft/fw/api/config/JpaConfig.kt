...
import kr.co.apexsoft.fw.lib.security.AuthUser
 ...
 */
@Configuration
@EntityScan(basePackages = ["kr.co.apexsoft.fw.domain"])  // common.domain 까지 명시하면 에러 발생
@EnableJpaRepositories(basePackages = ["kr.co.apexsoft.fw.domain"])  // common.domain 까지 명시하면 에러 발생
