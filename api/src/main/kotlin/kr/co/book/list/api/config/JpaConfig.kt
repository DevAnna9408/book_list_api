...
import kr.co.book.list.lib.security.AuthUser
 ...
 */
@Configuration
@EntityScan(basePackages = ["kr.co.book.list.domain"])  // common.domain 까지 명시하면 에러 발생
@EnableJpaRepositories(basePackages = ["kr.co.book.list.domain"])  // common.domain 까지 명시하면 에러 발생
