...
class BookController (
    ...
    fun getRandomBook(
        @RequestParam("userOid") userOid: Long
    ): ResponseEntity<BookOut> = ResponseEntity.ok(bookCommandService.getRandomBook(userOid))
    ...
    fun thumbsUp(
        @RequestParam ("userOid") userOid: Long,
        @RequestParam ("bookOid") bookOid: Long
    ): ResponseEntity<BookOut> = ResponseEntity.ok(bookCommandService.thumbsUp(userOid, bookOid))
    ...
    fun thumbsDown(
        @RequestParam ("userOid") userOid: Long,
        @RequestParam ("bookOid") bookOid: Long
    ): ResponseEntity<BookOut> = ResponseEntity.ok(bookCommandService.thumbsDown(userOid, bookOid))
    ...
    ): ResponseEntity<Page<BookOut>> = ResponseEntity.ok(bookQueryService.getAllBookListReversed(
            userOid,
            pageable
    ))
    ...
    fun getAllBookList(
        @RequestParam("userOid") userOid: Long,
        @ParameterObject pageable: Pageable
    ): ResponseEntity<Page<BookOut>> = ResponseEntity.ok(bookQueryService.getAllBookList(
            userOid,
            pageable
    ))
    ...
    fun getAllMyBookList(
        @RequestParam("userOid") userOid: Long,
        @ParameterObject pageable: Pageable
    ): ResponseEntity<Page<BookOut>> = ResponseEntity.ok(bookQueryService.getAllMyBookList(
            userOid,
            pageable
    ))
    ...
    fun getPostCountAndThumbsUp(
        @RequestParam("userOid") userOid: Long
    ): ResponseEntity<PostCountAndThumbsUpOut> = ResponseEntity.ok(bookQueryService.getPostCountAndThumbsUp(userOid))
